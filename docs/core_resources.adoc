...
template<typename T>
using ResourceLoader = std::function<std::unique_ptr<T>(const std::filesystem::path&)>; <1>
template<typename T>
using ResourceLoader = std::function<std::unique_ptr<T>(const std::filesystem::path&, const ResourceContext<T>&)>; <2>
----
