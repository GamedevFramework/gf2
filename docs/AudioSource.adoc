...
An audio source may be spatialized. By default, it is not spatialized, you must enable spatialization with <<_set_spatialization_enabled>>.
...
See also: <<_set_directional_attenuation_factor>>
...
See also: <<_set_listener>>, xref:AudioListener.adoc[`AudioListener`]
...
See also: <<_directional_attenuation_factor>>
...
See also: <<_listener>>, xref:AudioListener.adoc[`AudioListener`]
...
See also: <<_spatialization_enabled>>
...
See also: <<_set_spatialization_enabled>>
