...
- xref:core_vec.adoc#distance2[`gf::Distance2<T>`] type
- xref:core_vec.adoc#distance3[`gf::Distance3<T>`] type
...
- xref:core_container.adoc#index_range_type[`gf::IndexRange`] type
...
- xref:core_container.adoc#position_range_type[`gf::PositionRange`] type
...
- xref:core_math.adoc#step[`gf::Step`] type
