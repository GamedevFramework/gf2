...
`Transform` contains all the information to compute an link:https://en.wikipedia.org/wiki/Transformation_matrix#Affine_transformations[affine transformation matrix].
