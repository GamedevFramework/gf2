...
See also: <<_microseconds>>, <<_operator_microseconds>>
...
See also: <<_milliseconds>>, <<_operator_milliseconds>>
...
See also: <<_seconds>>, <<_operator_seconds>>
...
See also: <<_as_microseconds>>

[#_operator_milliseconds]
