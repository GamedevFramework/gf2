...
**Gamedev Framework 2** (gf2) is a modern framework to build 2D games in C++20. It is based on [SDL 3](https://libsdl.org/) and provides high-level constructions to easily build games.
