...
namespace gf {
  ...
  {
    const ma_vec3f position = ma_engine_listener_get_position(m_engine, m_index);
  ...
  {
    const ma_vec3f direction = ma_engine_listener_get_direction(m_engine, m_index);
  ...
  {
    const ma_vec3f velocity = ma_engine_listener_get_velocity(m_engine, m_index);
  ...
  {
    const ma_vec3f direction = ma_engine_listener_get_world_up(m_engine, m_index);
    return { direction.x, direction.y, direction.z };
  }
